...
<head>
    ...
    <style>
        ...
        button { padding: 10px 20px; background-color: #0066cc; color: white; border: none; }
    </style>
</head>
<body>
    ...
    switch ($table) {
        ...
        case 'vaccination_records': $fields = ['animal_id' => $row['animal_id'], 'vaccine_name' => $row['vaccine_name'], 'administration_date' => $row['administration_date'], 'next_due_date' => $row['next_due_date'], 'administered_by' => $row['administered_by'], 'notes' => $row['notes']]; break;
    ...
    <p><a href="indexx.php">Back to Dashboard</a></p>
</body>
</html>