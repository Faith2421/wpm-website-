...
<body>
  ...
  <div class="container">
    <div id="farmer" class="section active">
      ...
      <form action="Farmer Details.php" method="POST">
    ...
    <div id="breeding" class="section">
      ...
      <form action="breeding information.php" method="POST">
      <input type="text" name="animalID" placeholder="Animal ID" />
    ...
    <div id="feeding" class="section">
      ...
      <form action="feeding and nutrient.php" method="POST">
      <input type="text" name="animalID" placeholder="Animal ID" />
    ...
    <div id="vaccination" class="section">
      ...
      <input type="date" name="administrationDate" placeholder="Administration Date" />
      <input type="date" name="nextDueDate" placeholder="Next Due Date" />
      <input type="text" name="administeredBy" placeholder="Administered By" />
      <textarea name="vaccinationNotes" placeholder="Vaccination Notes"></textarea>
      <input type="submit">
    </form>
    </div>
    ...
    <div id="mortality" class="section">
      ...
      <form action="Mortality rates.php" method="POST">
      <input type="text" name="animalID" placeholder="Animal ID" />
    ...
    <div id="movement" class="section">
      ...
      <form action="Movement and Sales.php" method="POST">
      <input type="text" name="animalID" placeholder="Animal ID" />
