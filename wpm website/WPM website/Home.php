...
<body>
  ...
  <div class="container">
    ...
    <div id="feeding" class="section">
      ...
      <form action="livestock_backend.php" method="POST">
      <input type="text" name="animalID" placeholder="Animal ID" />
      <input type="text" name="feedType" placeholder="Feed Type" />
      <input type="text" name="quantity" placeholder="Quantity" />
      <input type="text" name="nutritionalInfo" placeholder="Nutritional Info" />
    ...
    <div id="movement" class="section">
      ...
      <form action="livestock_backend.php" method="POST">
      <input type="text" name="animalID" placeholder="Animal ID" />
      <input type="text" name="movementType" placeholder="Movement Type (e.g. Sale, Transfer Out)" />
      <input type="date" name="movementDate" placeholder="Date" />  
      <input type="text" name="destination" placeholder="Destination" />
      <input type="text" name="contactPerson" placeholder="Contact Person" />
      <input type="text" name="contactPersonNumber" placeholder="Contact Person Number" />
      <input type="number" step="0.01" name="price" placeholder="Price" />
      <textarea name="movementNotes" placeholder="Notes"></textarea>
      <br>
      <input type="submit">
    </form>
    </div>
